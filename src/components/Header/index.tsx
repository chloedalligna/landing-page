    ...
    <header className={`${scrolled ? 'scrolled' : ''} ${hidden ? 'hidden' : ''}`}>
        ...
        <nav>
            <ul>
                ...
                <li><a href="#section-about" onClick={handleLinkClick}>Sobre</a></li>

                <li><a href="#section-schedule" onClick={handleLinkClick}>Cronograma</a></li>

                <li><a href="#section-tickets" onClick={handleLinkClick}>Ingressos</a></li>

                <li><a href="#section-location" onClick={handleLinkClick}>Localização</a></li>

                <li><a href="#section-form" onClick={handleLinkClick}>Newsletter</a></li>
                
                <li><a href="#section-contacts" onClick={handleLinkClick}>Contato</a></li>
            </ul>
        </nav>
    </header>
  );
